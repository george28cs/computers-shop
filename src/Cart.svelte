  ...
  <table class="cart">
    ...
    {#each cartItems as item}
      <tr>
        ...
        <td class="remove-item" on:click={removeItem(item.id)}>
          <img class="trash" src="https://cdn3.iconfinder.com/data/icons/linecons-free-vector-icons-pack/32/trash-512.png" alt="trash" />
        </td>
      </tr>
    {/each}
  </table>
